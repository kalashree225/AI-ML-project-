...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-demo-key-for-development-only')
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,  # Simplified - no blacklist
...
# AI/ML Settings (OpenAI is optional)
